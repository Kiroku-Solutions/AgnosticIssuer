 ...
 * ```
 * .nomad.md/.trash/<timestamp>-<originalName>
 * ```
 ...
 * trash triggers creation of `.nomad.md/.trash/`.
 *
 ...
 * @returns The trash path the file was moved to (`.nomad.md/.trash/<timestamp>-<name>`).
